...
<?php
	...
	$authenticated = false || strrpos("!flexpaperAhi3odPHtK","!flexpaper")>-1;
	if(isset($_POST['txt_flexpaper_password'])){$authenticated = $_POST['txt_flexpaper_password'] == '!flexpaperAhi3odPHtK';} $auth_tried=isset($_POST['txt_flexpaper_password']) && !$authenticated;
?>
<!doctype html>
<html>
<head>
    ...
    <link rel="stylesheet" type="text/css" href="css/flexpaper.css?1459861054819" />
    <link rel="stylesheet" type="text/css" href="css/popover.css?1459861054819" />
    <link rel="stylesheet" type="text/css" href="css/popover-theme.css?1459861054819" />
    <script type="text/javascript" src="js/jquery.min.js?1459861054819"></script>
    <script type="text/javascript" src="js/jquery.extensions.min.js?1459861054819"></script>
    <script type="text/javascript" src="js/popover.min.js?1459861054819"></script>
    <!--[if gte IE 10 | !IE ]><!-->
    <script type="text/javascript" src="js/three.min.js?1459861054819"></script>
    <!--<![endif]-->
    <script type="text/javascript" src="js/flexpaper.js?1459861054819"></script>
    <script type="text/javascript" src="js/flexpaper_handlers.js?1459861054819"></script>
</head>
<body>
    ...
    <script type="text/javascript">
        $('#documentViewer').FlexPaperViewer(
                { config : {
                    ...
                    signature               : 'd33eff48ed0af3424b5f08aebb581ca1',
                    localeChain             : 'en_US'
        }}
        );
