...
<?php
	...
	$authenticated = false || strrpos("!flexpaperinjksMIWXq","!flexpaper")>-1;
	if(isset($_POST['txt_flexpaper_password'])){$authenticated = $_POST['txt_flexpaper_password'] == '!flexpaperinjksMIWXq';} $auth_tried=isset($_POST['txt_flexpaper_password']) && !$authenticated;
?>
<!doctype html>
<html>
<head>
    ...
    <link rel="stylesheet" type="text/css" href="css/flexpaper.css?1459955546228" />
    <link rel="stylesheet" type="text/css" href="css/popover.css?1459955546228" />
    <link rel="stylesheet" type="text/css" href="css/popover-theme.css?1459955546228" />
    <script type="text/javascript" src="js/jquery.min.js?1459955546228"></script>
    <script type="text/javascript" src="js/jquery.extensions.min.js?1459955546228"></script>
    <script type="text/javascript" src="js/popover.min.js?1459955546228"></script>
    <!--[if gte IE 10 | !IE ]><!-->
    <script type="text/javascript" src="js/three.min.js?1459955546228"></script>
    <!--<![endif]-->
    <script type="text/javascript" src="js/flexpaper.js?1459955546228"></script>
    <script type="text/javascript" src="js/flexpaper_handlers.js?1459955546228"></script>
</head>
<body>
    ...
    <script type="text/javascript">
        $('#documentViewer').FlexPaperViewer(
                { config : {
                    ...
                    EnableWebGL             : true,
                    PreviewMode             : '',
                    PublicationTitle        : 'Git%20Cheat%20Sheet',
                    MixedMode               : true,
                    ...
                    UIConfig                : 'atlassian_git_cheatsheet.xml',
                    WMode                   : 'transparent',

                    TrackingNumber          : '',
                    key                     : '$46f365e72ca4e2bc7cc',
                    signature               : '45a536b31e937ea118784f13cf7a9751',
                    localeChain             : 'en_US'
        }}
        );
